...
//For Display TEXT
const int font1 = reinterpret_cast<intptr_t>(GLUT_BITMAP_TIMES_ROMAN_24);
const int font2 = reinterpret_cast<intptr_t>(GLUT_BITMAP_HELVETICA_18);
const int font3 = reinterpret_cast<intptr_t>(GLUT_BITMAP_8_BY_13);
